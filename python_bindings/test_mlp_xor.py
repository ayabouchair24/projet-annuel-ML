...
# 1. Chargement de la DLL / Dylib
clion_mingw = r"C:\Program Files\JetBrains\CLion 2026.2.2\bin\mingw\bin"

# Vérification hasattr(os, 'add_dll_directory') pour compatibilité macOS/Linux
if os.path.exists(clion_mingw) and hasattr(os, "add_dll_directory"):
